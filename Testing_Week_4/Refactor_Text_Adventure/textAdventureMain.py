...
def doTurn():
    ...
    for text in scene.preText:
        gameState.lastRepeated = textAdventureFormatting.gamePrint(text.replace("%name%", gameState.name), "*", gameState.lastRepeated)
...
gameState = gameStateClass("Sir Arthur", "easy")
